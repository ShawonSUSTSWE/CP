...
out :
    ...
    while (app.isOpen())
    {
        ...
        if ( CoinY > SCREEN_HEIGH )
        {
            ...
            cout << "same\n";
            CoinX = getRandomNumber(borderLeft,borderRight);
            if ( ( ( ( CoinX >= ( Obs1X-62 ) ) && ( CoinX <= ( Obs1X+22 ) ) ) && ( ( CoinY >= ( Obs1Y-50 ) )  && ( CoinY ) <= ( Obs1Y+80 ) ) )   || ( ( ( CoinX >= ( Obs2X-62 ) ) && ( CoinX <= ( Obs2X+22 ) ) ) && ( ( CoinY >= ( Obs2Y-50 ) )  && ( CoinY ) <= ( Obs2Y+80 ) ) ) || ( ( ( CoinX >= ( Obs3X-62 ) ) && ( CoinX <= ( Obs3X+22 ) ) ) && ( ( CoinY >= ( Obs3Y-50 ) )  && ( CoinY ) <= ( Obs3Y+80 ) ) ) || ( ( ( CoinX >= ( Obs4X-62 ) ) && ( CoinX <= ( Obs4X+22 ) ) ) && ( ( CoinY >= ( Obs4Y-50 ) )  && ( CoinY ) <= ( Obs4Y+80 ) ) ) )
                goto same;
        }
        ...
        if (((RacerX>=(CoinX-35)) &&(RacerX<=(CoinX+65)))&&((RacerY>=(CoinY-95)) &&(RacerY-50)<=(CoinY+5)))
        {
            ...
            CoinY=-1632;
            CoinX=getRandomNumber(borderLeft,borderRight);
            if ( ( ( ( CoinX >= ( Obs1X-30 ) ) && ( CoinX <= ( Obs1X+30 ) ) ) && ( ( CoinY+50 >= ( Obs1Y-30 ) )  && ( CoinY-50 ) <= ( Obs1Y+30 ) ) )   || ( ( ( CoinX >= ( Obs2X-30 ) ) && ( CoinX <= ( Obs2X+30 ) ) ) && ( ( CoinY+50 >= ( Obs2Y-30 ) )  && ( CoinY-50 ) <= ( Obs2Y+30 ) ) ) || ( ( ( CoinX >= ( Obs3X-30 ) ) && ( CoinX <= ( Obs3X+30 ) ) ) && ( ( CoinY+50 >= ( Obs3Y-30 ) )  && ( CoinY-50 ) <= ( Obs3Y+30 ) ) ) || ( ( ( CoinX >= ( Obs4X-30 ) ) && ( CoinX <= ( Obs4X+30 ) ) ) && ( ( CoinY+50 >= ( Obs4Y-30 ) )  && ( CoinY-50 ) <= ( Obs4Y+30 ) ) ) )
                CoinX = getRandomNumber(borderLeft,borderRight);
            coin.setPosition(CoinX,CoinY);
        }
