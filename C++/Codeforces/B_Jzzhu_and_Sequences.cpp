...

{
    ...
    {
        ll num = 1000000007;
        while (x < 0 && -x > num) num += 1000000007;  
        return num+x;
    } 
...

{
    ll x, y, n;
    cin >> x >> y >> n;
    if ( n%6 == 0 ) cout << mod((x-y)) << endl;
    else if ( n%6 == 5 ) cout << mod(-y) << endl;
    else if ( n%6 == 4 ) cout << mod(-x) << endl;
    else if ( n%6 == 3 ) cout << mod((y-x)) << endl;
    else if ( n%6 == 2 ) cout << mod(y) << endl;
